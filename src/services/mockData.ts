...
export const mockAlerts: AlertLog[] = [
  {
    ...
    message_text: 'Lot MAN-2024-001 (Toyota Hilux SR5) changed from Watch to Buy',
    link: 'https://manheim.com.au/lot/001',
    status: 'new',
    dedup_key: 'Smith Motors|MAN-2024-001|Watch→Buy|2024-01-15',
    lot_make: 'Toyota',
    lot_model: 'Hilux',
    lot_variant: 'SR5',
    lot_year: 2021,
    auction_house: 'Manheim',
    estimated_margin: 3500,
    why_flagged: ['PASSED IN x3+', 'MARGIN OK'],
  },
];
