...
import DealerIntelligencePage from "./pages/operator/DealerIntelligencePage";
        ...
        <BobSiteContextProvider>
          ...
          <TooltipProvider>
            ...
            <Routes>
              ...
              <Route path="/operator/easycars-posting" element={<OperatorGuard><EasyCarsPostingPage /></OperatorGuard>} />
