...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`[TOYOTA] Loaded ${allWinners.length} winners across all accounts`);
    ...
    console.log(`[TOYOTA] Winners: ${stats.winner_hits}, Bottom 40%: ${cheapest.length} of ${remainingAfterWinners.length}`);
