...
import { BROWSER_WORKER_FUNCTION_MAP } from '../_shared/browser_workers.js';
const FN_MAP = { ...WORKER_FUNCTION_MAP, ...DATA_WORKER_FUNCTION_MAP, ...BROWSER_WORKER_FUNCTION_MAP };
