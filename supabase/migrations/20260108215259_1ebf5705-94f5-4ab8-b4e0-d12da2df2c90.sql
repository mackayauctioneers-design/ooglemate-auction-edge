-- Update location_to_region to add Smithfield (Sydney suburb)
...
BEGIN
  ...
  -- NSW_SYDNEY_METRO - Greater Sydney (added smithfield)
  IF loc ~ '(sydney|parramatta|blacktown|penrith|liverpool|campbelltown|bankstown|canterbury|auburn|strathfield|burwood|ashfield|leichhardt|marrickville|rockdale|kogarah|hurstville|sutherland|cronulla|miranda|caringbah|chatswood|willoughby|lane cove|ryde|hornsby|ku-ring-gai|manly|dee why|brookvale|mona vale|frenchs forest|castle hill|baulkham hills|epping|eastwood|macquarie park|north sydney|mosman|neutral bay|cremorne|crows nest|artarmon|st leonards|gordon|pymble|turramurra|wahroonga|lindfield|roseville|chullora|enfield|silverwater|auburn|homebush|rhodes|concord|five dock|drummoyne|balmain|rozelle|glebe|camperdown|newtown|erskineville|alexandria|redfern|surry hills|darlinghurst|paddington|bondi|coogee|maroubra|mascot|botany|kingsford|randwick|kensington|zetland|waterloo|green square|smithfield|wetherill park|fairfield|cabramatta|guildford|granville|merrylands|wentworthville|westmead|seven hills|doonside|rooty hill|mount druitt|st marys|emu plains|glenmore park|leppington|oran park|narellan|camden|picton|appin)' THEN
