-- Fix fn_build_retail_geo_heat_sa2_daily - use model directly (no model_family column exists)
...
BEGIN
  ...
  -- Using model as model_key (vehicle_listings has model, not model_family)
