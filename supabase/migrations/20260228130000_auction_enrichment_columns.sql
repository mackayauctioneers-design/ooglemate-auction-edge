-- ─────────────────────────────────────────────────────────────────────────────
-- Auction enrichment columns
-- Adds fields extracted by Manus to pickles_detail_queue and vehicle_listings
-- so that wovr, condition, fuel, transmission, and reserve data are persisted.
-- ─────────────────────────────────────────────────────────────────────────────
...
-- (fuel and transmission already exist; add the missing ones)
...
-- ── ingestion_sources: register auction-detail-enricher for health monitoring ─
