-- Fix column names in rpc_build_unified_candidates to match hunt_external_candidates schema
...
BEGIN
  ...
  INSERT INTO hunt_unified_candidates (hunt_id, criteria_version, source_type, source_key, source_tier, url, asking_price, km, year,
  ...
  SELECT ic.hunt_id, ic.criteria_version, ic.source_type, ic.source_key, ic.source_tier, ic.url, ic.asking_price, ic.km, ic.year,
  ...
  WITH outward_classified AS (
    SELECT hec.id, hec.hunt_id, hec.source_url AS url, hec.title, hec.raw_snippet AS snippet,
      hec.make, hec.model, hec.variant_raw, hec.asking_price, hec.km, hec.year, hec.source_name AS source,
  ...
  INSERT INTO hunt_unified_candidates (hunt_id, criteria_version, source_type, source_key, source_tier, url, asking_price, km, year,
    identity_key, identity_confidence, identity_evidence, series_family, engine_family, body_type, cab_type, badge,
    listing_intent, listing_intent_reason, match_score, decision, reasons, verified, rank_score, sort_reason)
  SELECT oc.hunt_id, v_criteria_version, 'outward'::TEXT, COALESCE(oc.source, 'web'),
